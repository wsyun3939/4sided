...
int main()
{
        ...
        for (int itr = 0; itr < TIER; itr++)
        {
                for (int a = 1; a <= 100; a++)
                {
                        ...
                        if (a % 100 == 1)
                        {
                                sprintf(filename, "../Benchmark2D/%d-%d-%d(bb1_unres).csv", TIER, STACK, nblock);
                                fp_csv = fopen(filename, "w");
                                sprintf(filename, "../Benchmark2D/%d-%d-%d(ip1_unresT).csv", TIER, STACK, nblock);
                        ...
                        if (a % 100 == 1)
                        {
                                sprintf(filename, "../Benchmark2D/%d-%d-%d(bb2_unres).csv", TIER, STACK, nblock);
                                fp_csv = fopen(filename, "w");
                                sprintf(filename, "../Benchmark2D/%d-%d-%d(ip2_unresT).csv", TIER, STACK, nblock);
                                fp_csv2 = fopen(filename, "w");
                        }
#endif
                        ...
                        if (a % 100 == 1)
                        {
                                sprintf(filename, "../Benchmark2D/%d-%d-%d(bb2s_unres).csv", TIER, STACK, nblock);
                                fp_csv = fopen(filename, "w");
                                sprintf(filename, "../Benchmark2D/%d-%d-%d(ip2s_unresT).csv", TIER, STACK, nblock);
                                fp_csv2 = fopen(filename, "w");
                        }
#endif
                        ...
                        if (a % 100 == 1)
                        {
                                sprintf(filename, "../Benchmark2D/%d-%d-%d(bb3_unres).csv", TIER, STACK, nblock);
                                fp_csv = fopen(filename, "w");
                                sprintf(filename, "../Benchmark2D/%d-%d-%d(ip3_unresT).csv", TIER, STACK, nblock);
                                fp_csv2 = fopen(filename, "w");
                        }
#endif
                        ...
                        if (a % 100 == 1)
                        {
                                sprintf(filename, "../Benchmark2D/%d-%d-%d(bb4_unres).csv", TIER, STACK, nblock);
                                fp_csv = fopen(filename, "w");
                                sprintf(filename, "../Benchmark2D/%d-%d-%d(ip4_unresT).csv", TIER, STACK, nblock);
                                fp_csv2 = fopen(filename, "w");
                        }
#endif
